...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void initState() {
    super.initState();
    // Start quiz after first frame so providers are ready.
                      ...
                      child: InkWell(
                        onTap: notifier.answered
                            ...
                            : () async {
                                ...
                                // Record result in GamificationNotifier for XP and mistakes
                                context
                                    .read<GamificationNotifier>()
                                    .recordQuizAnswer(
                                        question.correctPattern.id, isCorrect);
  ...
  Widget _buildResultScreen(
    ...
    final xpEarned = notifier.score * RewardConstants.quizCorrectXp;
