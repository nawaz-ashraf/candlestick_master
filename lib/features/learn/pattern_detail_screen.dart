...
import 'package:candlestick_master/widgets/full_screen_image_view.dart';
      ...
      builder: (context, progressNotifier, child) {
        ...
        return GestureDetector(
          onTap: () {
            ...
            // Award XP in Gamification system if marking as learned
            if (!isLearned) {
              context.read<GamificationNotifier>().completeLesson(pattern.id);
            }
              ...
              SnackBar(
                content: Text(
                  isLearned
                      ...
                      : 'Great! "${pattern.name}" marked as learned! +10 XP',
                ),
